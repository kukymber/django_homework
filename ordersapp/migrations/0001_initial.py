    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now_add=True, verbose_name='Обнoвлен')),
                ('paid', models.DateTimeField(verbose_name='оплачен')),
                ('status', models.CharField(choices=[('FM', 'формируется'), ('STP', 'отправлен в обработку'), ('PD', 'оплачен'), ('PRD', 'обрабатывется '), ('RDY', 'готов к выдаче'), ('CNC', 'отмена заказа ')], default='FM', max_length=3, verbose_name='статус')),
